...
class Utils {
    static final String PIZZA_1_TITLE = "Next level Margherita pizza";
    static final String PIZZA_1_DESCRIPTION = "Forget takeaways – you can’t beat a homemade Margherita pizza topped with fresh tomato sauce and melted cheese." +
            " Here's how to master this everyday classic.";
    ...
    static final String PIZZA_2_TITLE = "Pizza Margherita in 4 easy steps";
    static final String PIZZA_2_DESCRIPTION = "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo!";
    ...
    static final String PIZZA_3_TITLE = "Caramelised onion & goat's cheese pizza";
    static final String PIZZA_3_DESCRIPTION = "Make a veggie pizza that's healthy and low-fat instead of ordering a takeaway. This easy recipe uses goat's cheese for tang while the onions give it sweetness";
    ...
    static final String PIZZA_4_TITLE = "Superhealthy pizza";
    static final String PIZZA_4_DESCRIPTION = "The quantities for this are generous, so if you have any leftovers, pop a wedge of cold pizza into your lunchbox the next day";
    ...
    static final String PIZZA_5_TITLE = "Frying pan pizza";
    static final String PIZZA_5_DESCRIPTION = "Not good for you? Think again, this easy to make pizza is low fat and full of calcium!";
    static final String PIZZA_5_RECIPE = "Heat oven to 220C/fan 200C/gas 7. Place the pepper, courgette and red onion on a large non-stick baking tray and drizzle with 1 tsp olive oil. Season well and toss to combine. Roast in the oven for 20 mins until soft and beginning to brown. Set aside.\n" +
            "\n" +
    ...
    static final String PIZZA_6_TITLE = "Egg & rocket pizzas";
    static final String PIZZA_6_DESCRIPTION = "Use seeded tortillas as pizza bases for a quick and healthy lunch - crack an egg in the centre and bake to boost protein intake!";
    ...
    static final String PIZZA_7_TITLE = "Sourdough pizza";
    static final String PIZZA_7_DESCRIPTION = "\n" +
    ...
    static final String PIZZA_8_TITLE = "Chicken tikka masala pizzas";
    static final String PIZZA_8_DESCRIPTION = "Rustle up our spiced chicken pizzas using naan bread in just 20 minutes. To balance the heat, serve them with dollops of mango chutney and natural yogurt!";
    static final String PIZZA_8_RECIPE = "Heat oven to 180C/160C fan/gas 4. Toss the red onion with the red wine vinegar and a good pinch of salt and set aside (the vinegar will soften the onion slightly, which is a blessing as no one wants completely raw onion on pizza).\n" +
            "\n" +
    ...
    static final String PIZZA_9_TITLE = "Ultimate pizza Margherita";
    static final String PIZZA_9_DESCRIPTION = "Take your senses on a trip to Italy with this authentic pizza Margherita";
    static final String PIZZA_9_RECIPE = "In a bowl, mix flour, semolina, salt and yeast. Make a dip in the middle, pour in oil, water, then stir and squeeze everything together (hands are easiest for this). The dough should feel very sticky (pic 1). When it is well mixed, cover and leave for 15 mins.\n" +
            "\n" +
    ...
    static final String PIZZA_10_TITLE = "Pizza with homemade sauce";
    static final String PIZZA_10_DESCRIPTION = "Make pizza for the family with a homemade base and tomato sauce. The recipe is perfect to get kids involved in cooking. Top with mozzarella and fresh basil";
    static final String PIZZA_10_RECIPE = "Tip the flour into a bowl, then stir in the yeast and 1 tsp salt. Make a well in the centre and pour in 200ml warm water (make sure it’s not too hot) along with the oil. Stir together with a wooden spoon until you have a soft, fairly wet dough.\n" +
            "\n" +

...
public class Utils {
    ...
    public static final String PIZZA_1_DESCRIPTION = "Forget takeaways – you can’t beat a homemade Margherita pizza topped with fresh tomato sauce and melted cheese." +
    ...
    public static final String PIZZA_7_DESCRIPTION = "\n" +
    ...
    public static final String PIZZA_8_DESCRIPTION = "Rustle up our spiced chicken pizzas using naan bread in just 20 minutes. To balance the heat, serve them with dollops of mango chutney and natural yogurt!";
    ...
    public static final String PIZZA_9_DESCRIPTION = "Take your senses on a trip to Italy with this authentic pizza Margherita";
    ...
    public static final String PIZZA_10_DESCRIPTION = "Make pizza for the family with a homemade base and tomato sauce. The recipe is perfect to get kids involved in cooking. Top with mozzarella and fresh basil";
